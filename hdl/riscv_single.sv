...
module riscvsingle (input  logic        clk, reset,
   ...
   controller c (Instr[6:0], Instr[14:12], Instr[30], BranchResult,
		 ...
		 ImmSrc, ALUControl, ALUSrcA, JalrSrc);
...
module controller (input  logic [6:0] op,
   ...
   maindec md (op, ResultSrc, MemWrite, Branch,
	       ALUSrc, RegWrite, Jump, ImmSrc, ALUOp, ALUSrcA, JalrSrc);
...
//   Branch, ALUOp[1:0], Jump, ALUSrcA[1:0], JalrSrc
// Total: 1+3+1+1+2+1+2+1+2+1 = 15 bits
// ============================================================
module maindec (input  logic [6:0] op,
   ...
   assign {RegWrite, ImmSrc, ALUSrc, MemWrite,
	   ResultSrc, Branch, ALUOp, Jump, ALUSrcA, JalrSrc} = controls;
   
   always_comb
     case(op)
       // RegWrite_ImmSrc_ALUSrc_MemWrite_ResultSrc_Branch_ALUOp_Jump_ALUSrcA_JalrSrc
       //    1      3      1       1         2        1      2     1     2       1
       7'b0000011: controls = 15'b1_000_1_0_01_0_00_0_00_0; // load (lb/lh/lw/lbu/lhu)
       7'b0100011: controls = 15'b0_001_1_1_00_0_00_0_00_0; // store (sb/sh/sw)
       7'b0110011: controls = 15'b1_xxx_0_0_00_0_10_0_00_0; // R-type
       7'b1100011: controls = 15'b0_010_0_0_00_1_01_0_00_0; // B-type (branches)
       ...
       7'b0110111: controls = 15'b1_100_1_0_00_0_00_0_10_0; // lui  (SrcA=0, add imm)
       7'b0010111: controls = 15'b1_100_1_0_00_0_00_0_01_0; // auipc (SrcA=PC, add imm)
       default:    controls = 15'bx_xxx_x_x_xx_x_xx_x_xx_x; // ???
     endcase
